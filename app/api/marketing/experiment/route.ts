...
export async function POST(request:Request){
  ...
  try{
    ...
    return NextResponse.json({configured:true,experiment,variant:{id:String(variant.id),hook:variantHook,status:"draft",scheduledFor},message:"Controlled hook variant created and sent to Approval Inbox."});
  }catch(error){
