...
import { developerApiEnabled, developerApiHourlyLimit } from "@/lib/developer/api-keys";
...
export async function GET(request:Request){
  ...
  return NextResponse.json({
    ...
    safety:{metered:true,perKeyHourlyRequestLimit:hourlyRequestLimit||null,failClosedWithoutRateLimit:true},
    endpoints:{
