...
export default function VoiceLab(){
  ...
  return <main className="voiceLabPage">
    <header className="voiceLabNav"><a href="/"><HayLogo/></a><nav><a href="/">HOME</a><a href="/studio">MARKETING OS</a><a href="/creator">CREATOR</a><a href="/quality">QUALITY</a></nav><span>HY-AM / VOICE LAB</span></header>
    ...
    <footer className="voiceLabFooter"><span>STANDARD → NATURAL → YEREVAN</span><span>TEXT → NATURALIZE → PRONOUNCE → TTS → CAPTIONS</span><a href="/quality">OPEN QUALITY BENCHMARK ↗</a></footer>
  </main>;
}
